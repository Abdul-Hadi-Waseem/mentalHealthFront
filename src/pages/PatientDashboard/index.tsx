		...
		try {
			let response = await axios.get(
				`${config.base_url}/patient/get_patient_health_score/${
					JSON.parse(
						localStorage.getItem("user_complete_information")
					).uid
				}`
			)
                  ...
                  >
                    PSC Test
									...
									<div>
										...
										{ageNumber && ageNumber > 16 ? (
											// Render the Screening Test component if age is greater than 16
											<h3
												onClick={showPSCQuestion}
												style={{
													fontSize: "34px",
											...
											// Render the PSC Test component if age is less than or equal to 16
											<h3
												onClick={showPSCQuestion}
												style={{
													fontSize: "34px",
