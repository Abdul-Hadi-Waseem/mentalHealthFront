...
const ChildIntakeSteper = lazy(
	() => import("../pages/ChildIntake/ChildIntakeSteper.tsx")
)
const DoctorDetails = lazy(
	() => import("../pages/SelectDoctor/DoctorDetails.tsx")
)
const SelectDoctor = lazy(
	() => import("../pages/SelectDoctor/SelectDoctor.tsx")
)
...
import TermsAndConditionsPage from "../pages/TermsAndConditionPage.tsx"
...
const AppointmentScheduler = lazy(
	() => import("../pages/Schedule Appointment/ScheduleAppoitment.tsx")
)
const ScheduleByDoctorDetails = lazy(
	() => import("../pages/ScheduleByDoctor/ScheduleByDoctorDetails.tsx")
)
...
const PatientDetails = lazy(
	() => import("../pages/PatientDetails/PatientDetails.tsx")
)
const PatientsHistory = lazy(
	() => import("../pages/PatientsHistory/PatientsHistory.tsx")
)
const UpcomingAppointment = lazy(() => import("../pages/UpcomingAppointment"))

// Patient
const PatientDashBoard = lazy(
	() => import("../pages/PatientDashboard/index.tsx")
)
const PatientPrescriptions = lazy(
	() => import("../pages/PatientPrescriptions/PatientPrescriptions.tsx")
)
const PatientVisits = lazy(
	() => import("../pages/PatientVisits/PatientVisits.tsx")
)
const AppoinmentByDoctor = lazy(
	() => import("../pages/ScheduleByDoctor/AppoinmentByDoctor.tsx")
)
const ShowAllDoctors = lazy(
	() => import("../pages/ShowAllDoctors/ShowAllDoctors.tsx")
)

// Settings Pages
const TeacherDetail = lazy(() => import("../components/TeacherDetail.tsx"))
const InstituteDashBoard = lazy(
	() => import("../pages/InstituteDashboard/index.tsx")
)
const HeroSectionNodeJs = lazy(
	() => import("../pages/PSC Test NodeJs/PSC-Test-Main.tsx")
)
const HeroSectionNodeJsMAIN = lazy(
	() => import("../pages/All-Tests-Common/Test-Main.tsx")
)
const PSC_Test_Quiz_NodeJs = lazy(
	() => import("../pages/PSC Test NodeJs/Psctestquiz.tsx")
)
const Tests_Quiz_NodeJs = lazy(
	() => import("../pages/All-Tests-Common/testquiz.tsx")
)
const ChangePassword = lazy(
	() => import("../pages/Settings/ProfilesPages/ChangePassword.tsx")
)
const PrivacyPolicy = lazy(
	() => import("../pages/Settings/ProfilesPages/PrivacyPolicy.tsx")
)
const Profile = lazy(
	() => import("../pages/Settings/ProfilesPages/Profile.tsx")
)
const TermsAndConditions = lazy(
	() => import("../pages/Settings/ProfilesPages/TermsAndConditions.tsx")
)
const StudentDashboard = lazy(
	() => import("../pages/StudentDashboard/index.tsx")
)
const TeacherDashboard = lazy(
	() => import("../pages/TeacherDashboard/index.tsx")
)

//video call
const PatientVideoCall = lazy(
	() => import("../pages/Video-Calls/patient-video-call.tsx")
)
const DoctorVideoCall = lazy(
	() => import("../pages/Video-Calls/doctor-video-call.tsx")
)
interface RouteItem {
	id: number
