...
const WhatWeTreat = lazy(()=>import("../pages/WhatWeTreat/WhatWeTreat"));

const ChildIntakeSteper = lazy(()=>import( "../pages/ChildIntake/ChildIntakeSteper.tsx"));
const DoctorDetails = lazy(()=>import("../pages/SelectDoctor/DoctorDetails.tsx")) ;
const SelectDoctor =lazy(()=>import("../pages/SelectDoctor/SelectDoctor.tsx"));

import User1 from "../assets/images/User1.png";
import User2 from "../assets/images/User2.png";
import User3 from "../assets/images/User3.png";
import User4 from "../assets/images/User4.png";
const PersonalizedOtp = lazy(()=>import( "../pages/Otp/Otp.tsx"));
const Account = lazy(()=>import( "../pages/Account/Account"));
const HeroSection = lazy(()=>import("../pages/PSC Test/PSC-Test-Main.tsx")) ;
const PSC_Test_Quiz = lazy(()=>import("../pages/PSC Test/Psctestquiz.tsx")) ;
const AppointmentScheduler = lazy(()=>import("../pages/Schedule Appointment/ScheduleAppoitment.tsx")) ;
const ScheduleByDoctorDetails = lazy(()=>import( "../pages/ScheduleByDoctor/ScheduleByDoctorDetails.tsx"));
const SelectUser = lazy(()=>import( "../pages/SelectUser/SelectUser"));

// Doctor
const DoctorDashBoard = lazy(()=>import("../pages/DoctorDashboard/index.tsx")) ;
const PatientDetails = lazy(()=>import("../pages/PatientDetails/PatientDetails.tsx"));
const PatientsHistory =lazy(()=>import("../pages/PatientsHistory/PatientsHistory.tsx")) ;
const UpcomingAppointment = lazy(()=>import( "../pages/UpcomingAppointment"));

// Patient
const PatientDashBoard = lazy(()=>import("../pages/PatientDashboard/index.tsx")) ;
const PatientPrescriptions = lazy(()=>import("../pages/PatientPrescriptions/PatientPrescriptions.tsx")) ;
const PatientVisits = lazy(()=>import("../pages/PatientVisits/PatientVisits.tsx")) ;
const AppoinmentByDoctor = lazy(()=>import("../pages/ScheduleByDoctor/AppoinmentByDoctor.tsx"));
const ShowAllDoctors = lazy(()=>import("../pages/ShowAllDoctors/ShowAllDoctors.tsx")) ;

// Settings Pages
const TeacherDetail =lazy(()=>import("../components/TeacherDetail.tsx")) ;
const InstituteDashBoard =lazy(()=>import("../pages/InstituteDashboard/index.tsx"));
const HeroSectionNodeJs = lazy(()=>import("../pages/PSC Test NodeJs/PSC-Test-Main.tsx")) ;
const HeroSectionNodeJsMAIN = lazy(()=>import("../pages/All-Tests-Common/Test-Main.tsx")) ;
const PSC_Test_Quiz_NodeJs = lazy(()=> import("../pages/PSC Test NodeJs/Psctestquiz.tsx"))  ;
const Tests_Quiz_NodeJs = lazy(()=>import("../pages/All-Tests-Common/testquiz.tsx")) ;
const ChangePassword = lazy(()=>import( "../pages/Settings/ProfilesPages/ChangePassword.tsx"));
const PrivacyPolicy = lazy(()=>import("../pages/Settings/ProfilesPages/PrivacyPolicy.tsx")) ;
const Profile = lazy(()=>import("../pages/Settings/ProfilesPages/Profile.tsx"));
const TermsAndConditions = lazy(()=>import( "../pages/Settings/ProfilesPages/TermsAndConditions.tsx"));
const StudentDashboard = lazy(()=>import("../pages/StudentDashboard/index.tsx")) ;
const TeacherDashboard = lazy(()=>import("../pages/TeacherDashboard/index.tsx")) ;

//video call
const PatientVideoCall = lazy(()=>import("../pages/Video-Calls/patient-video-call.tsx")) ;
const DoctorVideoCall = lazy(()=>import("../pages/Video-Calls/doctor-video-call.tsx")) ;
interface RouteItem {
  id: number;
